...
then
	...
	if [[ -d /sys/firmware/efi ]]
	then
		pacstrap /mnt base base-devel linux-zen linux-firmware linux-zen-headers grub efibootmgr os-prober bash-completion sudo nano vim networkmanager ntfs-3g neofetch htop git reflector xdg-user-dirs e2fsprogs man-db
	else
		pacstrap /mnt base base-devel linux-zen linux-firmware linux-zen-headers grub os-prober bash-completion sudo nano vim networkmanager ntfs-3g neofetch htop git reflector xdg-user-dirs e2fsprogs man-db
	fi
	# fstab
